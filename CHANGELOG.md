...
authentication, JSON state, dry runs, investigation tickets, Hermes
Agent v0.18.2, and migration from the legacy v0 cron processor.

### Added

- Rust daemon, Python reference bridge, and Hermes plugin.
- Dry-run and investigation-ticket workflows.
- Legacy v0 migration with `caduceus migrate-state` and corruption
...
- Version 0.1.0 did not publish a security contact or disclosure
  policy.
