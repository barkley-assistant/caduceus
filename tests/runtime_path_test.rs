//! Task 2.8 integration suite — proves the corrected runtime path.
//!
...
// ---------------------------------------------------------------------------
// AC-01 companion: bridge env contract matches daemon contract
// ---------------------------------------------------------------------------
//
// The bridge's REQUIRED_ENV_VARS tuple must exactly match the
// canonical set from CONTRACTS.md RUN-001. This test parses the
...
// ---------------------------------------------------------------------------
// AC-04: Production-surface scanner
// ---------------------------------------------------------------------------
//
...
// ---------------------------------------------------------------------------
// AC-02 companion: status command diagnostic mapping is exhaustive
// ---------------------------------------------------------------------------
