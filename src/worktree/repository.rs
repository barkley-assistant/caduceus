...
pub async fn find_main_clone(
    ...
    // branch is mid-edit). With worktrees relocated under the
    // daemon state directory, a `.worktrees/` directory inside the
    // main checkout is genuine dirt and must not be tolerated.
